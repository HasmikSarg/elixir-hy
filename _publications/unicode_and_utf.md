---
layout: publication
title: "Unicode-ը և UTF կոդավորումները"
description: "Unicode-ի ստեղծման պատմությունը, code point-երի ներկայացումը և UTF-8, UTF-16 ու UTF-32 կոդավորումների կառուցվածքն ու տարբերությունները"
lang: hy
date: 2026-08-01 17:52:28 +0400
---

## Unicode-ը և UTF կոդավորումները

[Bitstring և binary տվյալների տիպերը հոդվածում](./bitstrings_and_binaries.md) տեսանք, որ Elixir-ի string-ը UTF-8-ով կոդավորված binary է։ Ծանոթացանք նաև բայթերին, code point-երին և `byte_size/1` ու `String.length/1` ֆունկցիաների տարբերությանը։ Սակայն դեռ չենք պարզել, թե ինչ խնդիր է լուծում Unicode-ը, ինչու ստեղծվեց UTF-8-ը և ինչով են իրարից տարբերվում UTF-8, UTF-16 ու UTF-32 կոդավորումները։
...
Բացի դրանից, մեկ փաստաթղթում մի քանի գրային համակարգ համատեղելը դժվար էր։ Հայերեն, ճապոներեն և արաբերեն պարունակող տեքստը չէր տեղավորվում որևէ մեկ բայթանոց կոդավորման մեջ։ Անհրաժեշտ էր միասնական համակարգ, որտեղ տարբեր լեզուների նշանները կունենային տարբերվող, ֆիքսված արժեքներ։
...
UTF-8-ի կարևոր հատկությունն այն է, որ ASCII տեքստը առանց փոփոխության նաև վավեր UTF-8 տեքստ է։ Օրինակ՝ ASCII-ում և UTF-8-ում `A`-ն ներկայացվում է նույն `0x41` բայթով։ Սա թույլ տվեց նոր կոդավորումը ներդնել առանց արդեն գոյություն ունեցող բազմաթիվ ֆայլային համակարգեր, ծրագրավորման լեզուների parser-ներ և ցանցային արձանագրություններ ամբողջությամբ վերափոխելու։
