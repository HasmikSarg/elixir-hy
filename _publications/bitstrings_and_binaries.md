...
String-երը մեր օրինակներում արդեն բազմիցս հանդիպել են՝ `"hello"`, `"world"` և այլն։ Այս հոդվածում կպարզենք, թե ի՛նչ է string-ը իրականում։ Դրա համար նախ պետք է ծանոթանանք Elixir-ի երկու հիմնարար տիպերի՝ bitstring-ի և binary-ի հետ։
...
Լռելյայն ամեն արժեքի հատկացվում է 8 բիթ, այսինքն՝ մեկ բայթ.
...
Իսկ ինչո՞ւ են փաստացի մեկ տվյալների տիպի համար երկու անվանում օգտագործում։ Bitstring-ն ավելի ընդհանուր տիպն է. այն թույլ է տալիս աշխատել նաև ոչ ամբողջական բայթերի հետ։ Դա պետք է գալիս հազվադեպ, ցածր մակարդակի խնդիրներում. օրինակ՝ որոշ ցանցային արձանագրություններում (network protocols) մեկ բայթի մեջ մի քանի փոքր դաշտ է խտացված, և դրանք կարդալու համար բայթը պետք է «բացել» բիթերի մակարդակով։ Այս թեմայի մեջ հիմա չենք խորանա. սովորելու ողջ ընթացքում գործ կունենաք միայն ամբողջական բայթերի, այսինքն՝ binary-ների հետ։
...
Նկատեցի՞ք. string-երը «միակցելու» օպերատորն իրականում binary-ների միակցման օպերատորն է։ Դա տրամաբանական է, քանի որ string-երը binary են։
...
1. Գրեք ձեր անունը հայերենով և հաշվեք `String.length`-ը ու `byte_size`-ը։ Համոզվեք, որ բայթերը տառերից երկու անգամ շատ են։
...
Այս հոդվածում մակերեսորեն անդրադարձանք pattern matching-ին՝ առանց այն բացատրելու։ Առաջիկայում կուղղենք այդ բացը. կխոսենք match operator-ի և pattern matching-ի մասին, որոնք Elixir-ի ամենակարևոր գործիքներից են։
