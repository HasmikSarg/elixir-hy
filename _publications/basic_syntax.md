...
lang: hy
date: 2026-07-10 09:09:13 +0400
---

## Elixir-ի բազային սինթաքսը
...
Ուշադրություն դարձրեք, որ տպված `Hello world`-ից հետո iex-ը ցույց է տալիս նաև `:ok` արժեքը։ Elixir-ում ամեն ֆունկցիա վերադարձնում է որևէ արժեք, և `IO.puts`-ը հաջող ավարտվելուց հետո վերադարձնում է `:ok`-ը։ Սա atom կոչվող տվյալների տիպ է, որին կծանոթանանք հետագայում։
